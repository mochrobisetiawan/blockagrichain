...
export function usePaged<T>(items: T[] | undefined | null, per = 6) {
  ...
  // Selalu tampil bila ada data (tombol nonaktif jika hanya 1 halaman) agar
  // kontrol pagination konsisten terlihat di semua list/tabel.
